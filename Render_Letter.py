...
if __name__ == "__main__":
    renderer = Renderer(800, 600, "Midterm Project")
    ...
    # Object(vertices, indices, pyrr.Matrix44.from_translation([...]), shader)
    ...
    renderer.object_rotation(20) # A rotation
    renderer.object_rotation(30) # C rotaion
    renderer.object_rotation(28) # L rotation
